  ...
  const CreateProduct = () => {
    ...
    const handleSubmit = async (e) => {
      ...
      // Validar que el producto tenga al menos una variación
      if (variations.length === 0 || variations.some(variation => 
        Object.values(variation).some(value => (value === "" || value === null || value === undefined) && value !== "" && value !== 0)
      )) {
        message.error('Debe ingresar al menos una variación con todos los campos completos');
        return;
      }
    
      // Validar los valores del producto
      ...
      const productData = {
        ...
        variations: variations.map((variation) =>({
          ...
          price_home: variation.price_home === "" ? null : parseInt(variation.price_home), // Permitir precio vacío, reemplazar con null
